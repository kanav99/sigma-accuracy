...
tokenizer = AutoTokenizer.from_pretrained('yoshitomo-matsubara/bert-large-uncased-qnli')
...
class BertClassifier(nn.Module):
    ...
    def __init__(self, num_classes, dropout=0.5):
        ...
        self.bert = AutoModelForSequenceClassification.from_pretrained('yoshitomo-matsubara/bert-large-uncased-qnli').bert
        self.dropout = nn.Dropout(dropout)
        self.linear = AutoModelForSequenceClassification.from_pretrained('yoshitomo-matsubara/bert-large-uncased-qnli').classifier
        self.relu = nn.ReLU()
