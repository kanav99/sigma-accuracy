...
class BertClassifier(nn.Module):
    ...
    def __init__(self, num_classes, dropout=0.5):
        ...
        self.bert = AutoModelForSequenceClassification.from_pretrained('yoshitomo-matsubara/bert-base-uncased-mrpc').bert
        self.dropout = nn.Dropout(dropout)
        self.linear = AutoModelForSequenceClassification.from_pretrained('yoshitomo-matsubara/bert-base-uncased-mrpc').classifier
        self.relu = nn.ReLU()
